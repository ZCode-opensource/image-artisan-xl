...
schedulers = [
    ...
    Scheduler("DPM++ 2M Lu", DPMSolverMultistepScheduler, dict(use_karras_sigmas=False, use_lu_lambdas=True)),
    Scheduler("DPM++ 2M Stable", DPMSolverMultistepScheduler, dict(use_karras_sigmas=False, euler_at_final=True)),
    ...
    Scheduler("DPM++ 2M SDE Lu", DPMSolverMultistepScheduler, dict(use_karras_sigmas=False, use_lu_lambdas=True, algorithm_type="sde-dpmsolver++")),
    Scheduler("DPM++ 2M SDE Stable", DPMSolverMultistepScheduler, dict(use_karras_sigmas=False, euler_at_final=True, algorithm_type="sde-dpmsolver++")),
