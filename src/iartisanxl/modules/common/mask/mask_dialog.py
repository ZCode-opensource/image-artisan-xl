...
class MaskDialog(BaseDialog):
    ...
    def init_ui(self):
        ...
        self.mask_editor_widget = MaskWidget("", "ip_adapter_mask", self.image_viewer, self.editor_width, self.editor_height)
    ...
    def on_save_mask(self):
        mask_pixmap = self.mask_editor_widget.image_editor.get_layer(1)
